...
export const spatialTextQuestions: Question[] = [
  ...
  },
  {
    ...
    category: "spatial",
    difficulty: 3,
    prompt: "A cube is painted on all six faces and cut into 27 identical smaller cubes. How many have paint on exactly one face?",
    answer: n(6),
    explanation: "One per face — the single cube at the centre of each face.",
  },
  {
    id: "spa-017",
    category: "spatial",
    difficulty: 4,
    prompt: "A 5 × 5 × 5 cube is painted on all faces and cut into 125 unit cubes. How many have no paint at all?",
    answer: n(27),
    explanation: "The unpainted core is a 3 × 3 × 3 block.",
  },
  {
    id: "spa-018",
    category: "spatial",
    ...
    answer: n(8),
    explanation: "Four on the top face and four on the bottom.",
  },
  {
    id: "spa-019",
    category: "spatial",
    difficulty: 3,
    prompt: "You are facing east. You turn 180°, then turn 90° to your right. Which way are you facing?",
    answer: c(["North", "South", "East", "West"], 0),
    explanation: "East → west → north.",
  },
  {
    id: "spa-020",
    category: "spatial",
    difficulty: 4,
    prompt: "A square sheet of paper is folded in half three times, then a single hole is punched through all the layers. How many holes appear when it is unfolded?",
    answer: n(8),
    explanation: "Three folds produce eight layers.",
  },
  {
    id: "spa-021",
    category: "spatial",
    difficulty: 3,
    prompt: "You walk 5 km east and then 12 km north. How many kilometres are you from your starting point in a straight line?",
    answer: n(13),
  ...
  },
  {
    ...
    category: "spatial",
    difficulty: 2,
    prompt: "What is the angle in degrees between the hands of a clock at exactly 3 o'clock?",
    answer: n(90),
    explanation: "Three hours out of twelve is a quarter of 360°.",
  },
  {
    id: "spa-023",
    category: "spatial",
    difficulty: 5,
    prompt: "What is the angle in degrees between the hands of a clock at 4:20?",
    answer: n(10),
    explanation: "The minute hand is at 120°; the hour hand has moved a third past four, to 130°.",
  },
  {
    id: "spa-024",
    category: "spatial",
    ...
    answer: n(8),
    explanation: "Four around the base and four rising to the apex.",
  },
  {
    id: "spa-025",
    category: "spatial",
    difficulty: 2,
    prompt: "A die shows 3 on the top face. Opposite faces add up to 7. What number is on the bottom?",
    answer: n(4),
    explanation: "7 − 3 = 4.",
  },
  {
    ...
    category: "spatial",
    difficulty: 5,
    prompt: "A 2 × 2 × 2 cube is painted on all six faces and cut into 8 unit cubes. How many of them have paint on exactly two faces?",
    answer: n(0),
    explanation: "Every unit cube is a corner of the original, so all eight show three painted faces and none shows exactly two.",
  },
  {
    id: "spa-027",
    category: "spatial",
    difficulty: 3,
    prompt: "You are facing north-east and turn 90° anticlockwise. Which direction are you facing?",
    answer: c(["North-west", "South-east", "South-west", "North"], 0),
    explanation: "North-east is 45°; subtracting 90° gives 315°, which is north-west.",
  },
  {
    id: "spa-028",
    category: "spatial",
    difficulty: 3,
    prompt: "A rectangle measures 8 by 6. How long is its diagonal?",
    answer: n(10),
    explanation: "A 6–8–10 right triangle.",
  },
  {
    id: "spa-029",
    category: "spatial",
    difficulty: 2,
    prompt: "How many faces does a regular octahedron have?",
    answer: n(8),
    explanation: "The name gives it away: octa- means eight.",
  },
  {
    id: "spa-030",
    category: "spatial",
    difficulty: 4,
    prompt: "A die is rolled along a straight line, making four successive quarter-turns in the same direction. Which face ends up on top?",
